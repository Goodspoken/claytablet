...
Целевая аудитория: технически грамотные пользователи (разработчики, сисадмины), которые сами деплоят ClayTablet и хотят расширять его под свои задачи без форка.
